...
$my_email = "sales@rocketlanders.com";
...
$message = $message . "From landing page: ".($_SERVER[HTTP_REFERER]);

$message = $message . PHP_EOL.PHP_EOL."-- ".PHP_EOL."Thank you for using Rocket Landers http://rocketlanders.com";

$message = stripslashes($message);

$subject = "Congratulations you have a new lead";
